define(['knockout', 'jquery'], function(ko, $) {
    function ComfortDashboardViewModel(params) {
        var self = this;

        self.setComfortTemperature = function() {
            var temp = $("#dashboard-comfort-temp").val();
            ...
            deviceEngine.writeVariable(varName, temp, function(res) {
                var alert = $("#dashboard-comfort-alert");
    ...
    ko.components.register('comfort-dashboard-component', {
        viewModel: ComfortDashboardViewModel,
        template: { require: 'text!view/component/comfort-dashboard-component.html' }
    });

    return ComfortDashboardViewModel;
});